---
title: Advanced Division: Selected Divisors
category: activities
---

# Advanced Division: Selected Divisors

**<u>Advanced Division: Selected Divisors</u>**
...
Â· multiple digits - up to 9,999,999,999,999 for divisors
...
1\. To choose the divisors for the exercise set, select the drop-down arrow for the Divisor option in the options pane.

2\. Select the desired divisors, then click OK to apply the selections to the math document.

Control for non-fractional answers

When Non-Fractional Answers is selected the program will attempt to generate questions with whole number answers (quotients). Ensure that Dividend, Decimals is set to 0, or this will override the non-fractional answers option.
