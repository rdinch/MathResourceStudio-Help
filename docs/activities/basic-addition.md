...
You can use multiple choice format to show the correct answer for each question.

Show Multiple Choice

To show multiple choice options for the questions, check the "Show Multiple Choice" box in the options panel. To hide them, uncheck the box.

Change How Choices Look

You can choose how the answer choices are displayed:

Â· Vertical: Shows all four choices in one column.

Â· Horizontal: Shows all four choices in one row.

Â· Stacked: Shows two choices in one column and the other two in another column.
...
<tbody>
<tr>
<td><p>TIP: Answer lines are shown by default. If you want to hide them, go to the "Exercise Set Display" section in the options panel.</p></td>
</tr>
</tbody>
</table>
