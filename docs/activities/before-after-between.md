...
Select just a single activity to focus on, or mix the activities.

1\. Select the Activity option in the options pane.

2\. Select the check box beside each of the desired activities.
