...
Select just one or a mix of fraction formats. Click in a check box by format to include that format for the exercise set.
...
CHANGE THE CARDINAL NUMBERS RANGE
