...
Control regrouping for mixed number minuends

When No Regrouping with Mixed Numbers is checked the minuends are controlled to ensure no regrouping is required.
...
NOTE: Minuend and subtrahend settings will be ignored or adjusted to ensure that no negative differences are produced.
...
Length (Vertical Orientation)

Choose between Normal and Extended answer lines when using the vertical orientation. The Extended line gives you more space to write your answer.
