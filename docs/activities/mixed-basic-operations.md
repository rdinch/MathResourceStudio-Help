...
<p>2. Type a new value in the field. Valid range is 0 to 99,999.</p></td>
</tr>
</tbody>
</table>
...
<tr>
<td><p>To set the distribution of values, select the desired distribution option (Normal or Balanced) next to the Distribution option in the options pane.</p>
<p>TIP: If you would like all questions to have a difference of 10, set both the Minimum Difference and Maximum Difference to 10.</p>
<p>2. Type a new value in the field. Valid range is 0 to 9999.</p></td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td><p>To set the distribution of values, select the desired distribution option (Normal or Balanced) next to the Distribution option in the options pane.</p></td>
</tr>
</tbody>
</table>
