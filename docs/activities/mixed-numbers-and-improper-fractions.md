...
**<u>Mixed Numbers and Improper Fractions</u>**
...
2\. Select mixed to improper, improper to mixed, or a random mix of the tasks.
...
1\. Select the variety of multiples to be generated by clicking the drop-down arrow for Denominators Multiples in the options pane.

2\. Select the desired multiples.

3\. Click OK to apply the selected denominator multiples.
