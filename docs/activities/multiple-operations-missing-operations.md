...
**<u>Multiple Operations: Missing Operations</u>**
...
Â· various operations and integers
...
Determine how many operators to hide

Set Hidden Operators from 1 to 5. If an equation has fewer than the number of set operators, all operators will be hidden. Example, if an equation has two operators and Hidden Operators is set to 4, all of the operators will be hidden in the equation.
...
Round fractional answers

This option sets the maximum number of decimal places the answer values should be rounded to. Click the up or down arrow to select the number of decimal places to be used for the exercise set.
