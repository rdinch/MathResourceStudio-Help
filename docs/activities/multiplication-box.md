...
TIP: If you are using the maximum high and low ranges you will probably need to use a to fit the puzzle on one page.
...
1\. To set the box size, select the Box Size option in the options pane.
...
Change the percentage of hidden values

1\. To change the percentage of hidden values, select the Hidden Values option in the options pane.
