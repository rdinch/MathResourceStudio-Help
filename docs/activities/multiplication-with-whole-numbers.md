...
**<u>Multiplication with Whole Numbers</u>**
...
2\. Click in the bubble by a task to select from Fractions of Whole Numbers, or Whole Numbers by Fractions, or a random mix of both tasks. The change will be applied immediately.
...
1\. To change the rounding for the cardinal (whole) numbers, select the Round To option in the options pane.

2\. Select the check box beside each of the desired place values to round to.

Ensure answers have no remainders

1\. To ensure that answers have no remainders, select the check box for the No Remainders option in the options pane.
