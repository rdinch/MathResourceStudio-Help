...
Select just one or a mix of fraction formats. Click in a check box by a format to include that format for the exercise set. Choices: Proper Fractions, Improper Fractions, Equivalent Fractions, Mixed Numbers.
