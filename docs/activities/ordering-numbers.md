...
2\. Select one or more number values, then click OK to apply the selected numbers to the document.
...
Change the ordering task

1\. To change the ordering task, select the Order option in the options pane.

2\. Select the desired ordering task.
