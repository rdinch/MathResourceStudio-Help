...
Set the rounding method, common or unbiased (banker's), for the exercise.

1\. To change the rounding method, select the Rounding Method option in the options pane.

2\. Click in the bubble next to the desired method. The exercise set is updated immediately.

Change the place values to round to

1\. To change the place values to round to, select the Round To option in the options pane and press the ellipsis button.
