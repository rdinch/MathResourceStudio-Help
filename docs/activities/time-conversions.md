...
1\. To set the conversion direction, click the Select Time Conversions option in the options pane and press the ellipsis button to display the Time Conversions dialog

2\. Select the desired common conversions by clicking in boxes by the conversions, or click Select All to select all of the conversions, or click again to clear all.

3\. Click OK to close the dialog and apply the selections to the document.
...
Select the remainder option for the answers
