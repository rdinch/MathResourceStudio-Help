...
The exercise set can focus just Multiplication or just Division or be a Mixed set of operations. Click the button by your choice to make your selection.

## Set the powers of ten

Select the powers of ten for the exercise set. Select a single power or powers. The powers of ten range from 1000 to .001. If no power of ten is selected, 10 will be used as the multiplier by default.

Include multiples

Determines whether multiples of the selected powers of ten will be used. For example, if 100 is selected for Powers of Ten, the values used will include 200, 300, 400, etc.

1. To use only the selected powers of ten, uncheck the box to Include Multiples in the options pane.

2. To use multiples of the selected powers of ten, check the box to Include Multiples in the options pane.
