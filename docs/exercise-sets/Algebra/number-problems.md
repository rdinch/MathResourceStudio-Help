...
## Change the active problems

1. To change the active problems, select the Problems option in the options pane and press the ellipsis button.

2. Select the desired problems and click OK.
