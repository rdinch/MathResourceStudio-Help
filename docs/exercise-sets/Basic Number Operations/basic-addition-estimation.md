# Basic Addition: Estimation 
# DRAFT ONLY with placeholder data for now.

<p style="color: red; font-weight: bold;">Under Review</p>

This exercise set provides students with practice using estimation to calculate an approximate answer. Students can also practice the estimation skill for checking whether the actual answer makes sense.
