...
1. To change the root values, select the Roots option in the options pane.

2. Select the check box beside each of the desired values.
...
1. To use non fractional solutions, select the check box for the Non Fractional Solutions option in the options pane.
