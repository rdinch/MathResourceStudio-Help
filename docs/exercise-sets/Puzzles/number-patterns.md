...
1. To set the level of difficulty for the exercise, select the Level of Difficulty option in the options pane.

2. Select the desired level.

NOTE Easy Patterns have a single repeating increment between the numbers that appear. Difficult Patterns will have a more complex pattern of increments.

Change how decimals will be used

1. To change how decimals will be used in the exercise, select the Decimals option in the options pane.
