...
With a math worksheet open, click the Sections down arrow in the Layout group on the ribbon and select One Column. A blank one column section is added to the worksheet. Before adding exercise sets to the section you can customize the options available in the right-side options pane.
