...
A Two Columns Auto section divides the page into two columns. Design items and exercise sets are placed automatically in the columns allowing for a balanced look.

With a math worksheet open, click the Sections down arrow in the Layout group on the ribbon and select Two Columns Auto. A blank two columns auto section is added to the worksheet. Before adding exercise sets to the section you can customize the options available in the right-side options pane.
