# Navigation Bar at the Top - Serial and Version Number at the Bottom

<p style="color: red; font-weight: bold;">Under Review</p>

Just above an open worksheet document is a navigation bar made up of navigation arrows and a Go To Page feature.
...
Serial numbers can be added to a header or footer by using the tag `<sn>` in a text field.
...
Version numbers can be added to a header or footer by using the tag `<v>` in a text field.
