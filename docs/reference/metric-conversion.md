...
1\. To select the active conversion units, select the Conversion Units option in the options pane and press the ellipsis button.

2\. Select the desired units and press OK.
...
Determines whether the conversion from metric units is to US units or Imperial units. This is relevant only for volume measures and mass measures involving tons.

1\. To set the measurement system, select the Convert To option in the options pane.
