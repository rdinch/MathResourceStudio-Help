...
**<u>Metric Weights and Measures</u>**
...
1\. To select the active metric units, select the Units of Measure option in the options pane and press the ellipsis button.

2\. Select the desired metric units and press OK.
...
1\. To set the conversion direction, select the Conversion Direction option in the options pane.

2\. Select the desired conversion direction.

Show answer unit symbols

Determines whether the unit symbols are shown for the answers. To show or not show the unit symbols, check or uncheck the check box for the Show Answer Unit Symbols option in the options pane.

Change the liter symbol format

1\. To change the liter symbol format, select the Liter Symbol Format option in the options pane.
