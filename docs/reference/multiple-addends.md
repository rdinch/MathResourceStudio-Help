...
Change the number of addends

Select from two to six addends for the exercise set.

1\. To change the number of addends, select the drop-down arrow for the Addends option in the options pane.

2\. Select one or more options for the number of addends to be used for the questions. If no options are selected, the exercises will default to two addends.
