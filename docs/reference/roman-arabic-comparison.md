...
In the options pane, choose the Comparison for the exercise set by selecting from just Roman to Arabic, just Arabic to Roman, or a Mixed set of questions.
