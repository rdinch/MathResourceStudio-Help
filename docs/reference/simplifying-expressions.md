...
Change the active expressions patterns

1\. To change the active expressions patterns, click the Select Patterns option in the options pane and press the ellipsis button.

2\. Select the desired expressions and click OK.
