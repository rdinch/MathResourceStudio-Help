...
1\. To select the active units of measure, select the Units of Measure option in the options pane and press the ellipsis button.
...
Change the remainder options

1\. To change the remainder options, select the Remainder Options option in the options pane.
